...
public class VideoCampaignLocators {
    ...
    public static final By videoNext = By.xpath("(//i[@class='fa fa-angle-right' and @data-placement='bottom'])[1]");
    public static final By videoLast = By.xpath("(//i[@class='fa fa-angle-double-right' and @data-placement='bottom'])[1]");
    public static final By videoPrevious = By.xpath("(//i[@class='fa fa-angle-left'])[1]");
    public static final By videoFirst = By.xpath("(//i[@class='fa fa-angle-double-left' and @data-placement='bottom'])[1]");
    ...
    public static final By eMailTemplateNext = By.xpath("(//i[@class='fa fa-angle-right' and @data-placement='bottom'])[2]");
    public static final By eMailTemplateLast = By.xpath("(//i[@class='fa fa-angle-double-right' and @data-placement='bottom'])[2]");
    public static final By eMailTemplatePrevious = By.xpath("(//i[@class='fa fa-angle-left'])[2]");
    public static final By eMailTemplateFirst = By.xpath("(//i[@class='fa fa-angle-double-left' and @data-placement='bottom'])[2]");
